...
namespace UGUI
{
    public partial class StartingForm : Form
    {
        ...
        private void customButton1_Click(object sender, EventArgs e)
        {
            ...
            _vPlayerRepairKitsReserve.Add(new RepairKit(30, REPAIR.LIGHT_KIT));
            _vPlayerRepairKitsReserve.Add(new RepairKit(30, REPAIR.FULL_KIT));
            _vPlayerRepairKitsReserve.Add(new RepairKit(30, REPAIR.LIGHT_ARMOR));
            _vPlayerRepairKitsReserve.Add(new RepairKit(30, REPAIR.HEAVY_ARMOR));

            _vPlayerFuelsReserve.Add(new RefuelKit(30, ENERGY.ENERGY_WOOD));
            _vPlayerFuelsReserve.Add(new RefuelKit(30, ENERGY.ENERGY_CHARCOAL));
            _vPlayerFuelsReserve.Add(new RefuelKit(30, ENERGY.ENERGY_COAL));
            _vPlayerFuelsReserve.Add(new RefuelKit(30, ENERGY.ENERGY_COMPACT_COAL));
            ...
            else
            {
                ...
                IWEAPON playerLeftWeap = new MELEE_WEAPON("1", "Melee Weapon", 3, 1, "", 2, 15, 100, 0);
